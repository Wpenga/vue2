  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="类型" prop="noticeType">
        <el-select  v-model="queryParams.noticeType" placeholder="请选择类型" style="width: 100%">
          <el-option v-for="item in noticeDict" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      <el-table-column label="公告类型" align="center" prop="noticeType" >
        <template slot-scope="scope">
          <el-tag type="primary" v-if="scope.row.noticeType === '0'">公告</el-tag>
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.noticeId != null) {
            this.form.updateTime =  this.parseTime(new Date(),'{y}-{m}-{d} {h}:{i}:{s}')
